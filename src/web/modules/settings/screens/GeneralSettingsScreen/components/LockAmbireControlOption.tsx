...
const LockAmbireControlOption = () => {
  ...
  return (
    <ControlOption
      style={spacings.mbTy}
      title={t('Lock UBAMM Wallet')}
      description={
        hasPasswordSecret
          ? t('Lock UBAMM Wallet extension, requiring your password the next time you use it.')
          : t('To lock UBAMM Wallet extension, please create a extension password first.')
      }

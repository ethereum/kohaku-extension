...
import DashboardOverviewSkeleton from '@web/modules/PPv1/tokenDetails/components/DashboardOverview/Skeleton'
import TabsAndSearchSkeleton from '@web/modules/PPv1/tokenDetails/components/TabsAndSearch/Skeleton'

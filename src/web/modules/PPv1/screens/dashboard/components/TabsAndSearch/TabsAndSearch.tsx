...
import Tabs from '@web/modules/PPv2/screens/dashboard/components/TabsAndSearch/Tabs/Tabs'
import useBanners from '@web/modules/PPv2/screens/dashboard/hooks/useBanners'
...
const getSearchPlaceholder = (openTab: TabType, t: TFunction) => {
  ...
  if (openTab === 'send') return t('Search for send')
  if (openTab === 'receive') return t('Search for receive')
...
const TABS = ['activity', 'send', 'receive']

...
const TransferForm = ({
  ...
  const [isWithdrawCheckboxAgreed, setIsWithdrawCheckboxAgreed] = useState(false)
  ...
  const onWithdrawCheckboxClick = useCallback(() => {
    // TODO: WIP
    setIsWithdrawCheckboxAgreed(!isWithdrawCheckboxAgreed)

    // dispatch({
    //   type: 'PRIVACY_POOLS_CONTROLLER_UPDATE_FORM',
    //   params: {
    //     formValues: { isWithdrawAgreed: true }
    //   }
    // })
  })
  ...
  return (
    ...
    >
      ...
      <View>
        ...
        <Checkbox
          value={isWithdrawCheckboxAgreed}
          onValueChange={onWithdrawCheckboxClick}
          label={t('Withdraw assets out of the pool')}
          style={spacings.mb0}
